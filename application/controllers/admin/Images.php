            ...
            else
            {
               ...
               // if(count($images_data)==1){
                	...
                	$insert_images = array();
	                    ...
	                    if(strlen($title)==0) $title = $images_data['file_name'];
	                    $insert_images[] = array(
	                        'file'=>$images_data['file_name'],
	                        'width'=>$images_data['image_width'],
	                        'height'=>$images_data['image_height'],
	                        'title'=>$title,
