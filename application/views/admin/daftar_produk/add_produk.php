...
<div id="container" class="container" style="padding-top:60px;">
	...
	<div id="body">
		...
		<?php endif; ?>
		<?= form_open_multipart('admin/daftar_produk/add')?>
		  ...
		  <div class="form-group">
		    <label for="caption">Judul Produk</label>
		    <input type="text" class="form-control" name="caption" value="">
		  </div>

		  <div class="form-group">
		    <label for="description">Diskripsi Produk</label>
		    <textarea class="form-control" name="description"></textarea>
		  </div>

		  <button type="submit" class="btn btn-primary">Upload</button>
		  <?php anchor('admin/daftar_produk/','Cancel',array('class'=>'btn btn-warning'))?>
