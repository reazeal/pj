...
insert  into `alat`(`alat_id`,`no_seri`,`merk`,`tipe`,`tgl_pembelian`,`harga`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`deleted_by`) values ('a44cb3752bd9e6ff35981272132d67d0','ASCDXZ','DAGADU','788-666','2016-03-10',5500000,'2016-03-10 09:04:15','2016-03-10 09:04:48',NULL,NULL,NULL,NULL);
...
/*Table structure for table `detail_penanggung_jawab` */

DROP TABLE IF EXISTS `detail_penanggung_jawab`;

CREATE TABLE `detail_penanggung_jawab` (
  `penanggung_jawab_id` int(11) NOT NULL,
  `pemasangan_id` varchar(255) NOT NULL,
...
insert  into `inbox`(`UpdatedInDB`,`ReceivingDateTime`,`Text`,`SenderNumber`,`Coding`,`UDH`,`SMSCNumber`,`Class`,`TextDecoded`,`ID`,`RecipientID`,`Processed`) values ('2016-03-21 16:31:51','2016-03-21 16:30:23','','+6285607733981','Default_No_Compression','','+62816124',-1,'Now,160321 09:29,A,19,27Km/h,89%,http://maps.google.com/maps?f=q&hl=en&q=-7.283683,112.738888&ie=UTF8&z=16&iwloc=addr&om=1',1,'ModemWirelessE','false');
...
insert  into `klien`(`no_pendaftaran`,`tanggal`,`nama`,`alamat`,`no_telp`,`no_hp`,`email`,`jenis`,`no_siup`,`created_at`,`updated_at`,`deleted_at`,`created_by`,`updated_by`,`deleted_by`) values ('000001/DAFTAR/III/16','2016-03-10','PT. SATU','GRESIK','0000000222','5555500000','nor.khakim@gmail.com','Perusahaan','sads555','2016-03-10 09:27:46',NULL,NULL,NULL,NULL,NULL),('000002/DAFTAR/III/16','2016-03-10','PT. DUA','GRESIK','0000000222','5555500000','nor.khakim@gmail.com','Perusahaan','sads555','2016-03-10 09:32:58',NULL,NULL,NULL,NULL,NULL),('000003/DAFTAR/III/16','2016-03-10','PT. TIGA','GRES','0000000222','5555500000','nor.khakim@gmail.com','Perusahaan','sads555','2016-03-10 09:33:19',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `pemasangan` (
  ...
  `no_rangka_kendaraan` varchar(100) DEFAULT NULL,
  `no_mesin_kendaraan` varchar(100) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
...
insert  into `phones`(`ID`,`UpdatedInDB`,`InsertIntoDB`,`TimeOut`,`Send`,`Receive`,`IMEI`,`Client`,`Battery`,`Signal`,`Sent`,`Received`) values ('ModemWirelessE','2016-03-21 16:33:25','2016-03-21 16:29:15','2016-03-21 16:33:35','yes','yes','353303059557257','Gammu 1.28.90, Windows Server 2007, GCC 4.4, MinGW 3.13',0,-1,5,4);
...
/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `update` AFTER INSERT ON `inbox` FOR EACH ROW BEGIN
	...
	ELSEif SUBSTRING_INDEX(new.TextDecoded,' ',1) ='NONAKTIF' then
	
	UPDATE tracking  SET `status`=0 WHERE nomor_seri_gps=SUBSTRING_INDEX(new.TextDecoded,' ',-1) AND `status`=1 ; 
	INSERT INTO outbox(DestinationNumber,TextDecoded,SenderID,CreatorID) 
	 VALUES(new.SenderNumber,CONCAT(SUBSTRING_INDEX(new.TextDecoded,' ',-1),' ','Berhasil diNonaktifkan'),'ModemWirelessE','Gammu 1.28.90');
