...
<div id="container" class="container" style="padding-top:60px;">
	...
	<div id="body">
		...
		<?php endif; ?>
		<?= form_open_multipart('admin/galeri_produk/add_tags/'.$image->id_galeri)?>

		  <div class="form-group">
		    <label for="caption">Tags</label>
		    <input type="text" class="form-control" name="nama_tags" value="">
		  </div>

		  <button type="submit" class="btn btn-primary">Tambah</button>
		  <?php anchor('admin/galeri_produk/','Cancel',array('class'=>'btn btn-warning'))?>
