...
<div id="container" class="container" style="padding-top:60px;">
	...
	<div id="body">
		...
		<?php endif; ?>
		<?=form_open_multipart('admin/slider_banner/edit/'.$image->id)?>

		  <div class="form-group">
		    <label for="userfile">Image File</label>
		    <div class="row" style="margin-bottom:5px"><div class="col-xs-12 col-sm-6 col-md-3"><?=img(array('src'=>$image->file,'width'=>'100%'))?></div></div>
		  ...
		  <?=anchor('admin/slider_banner','Cancel',array('class'=>'btn btn-warning'))?>
