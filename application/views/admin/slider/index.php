...
<div id="container" class="container" style="padding-top:60px; width: auto !important;">
	...
	<div id="body">
		...
		if($slider_banner->num_rows() > 0) : ?>
			...
			<div align="center"><?= anchor('admin/slider_banner/add','Tambah Slide',array('class'=>'btn btn-primary'))?></div>			
			<hr />	
			<div class="row">
			<table width="100%" align="center" border="0">
						<tr>
							<td>
								<?php foreach($slider_banner->result() as $img) : ?>
									<div class="col-md-3">
										<div class="thumbnail"  style="width: auto !important;">
										
										
											<?php 
											echo " <img src=\"".site_url($img->file)."\" alt=\"".$img->caption."\">";
											?>
											<div class="caption">
												<h4><?php echo $img->caption; ?></h4>
												<p><?php echo substr($img->description, 0,100)?>...</p>
												<p>
													<?php echo anchor('admin/slider_banner/edit/'.$img->id,'Edit',array('class'=>'btn btn-warning', 'role'=>'button')); ?>
													<?php echo anchor('admin/slider_banner/delete/'.$img->id,'Delete',array('class'=>'btn btn-danger', 'role'=>'button','onclick'=>'return confirm(\'Are you sure?\')'))?>
												</p>
											</div>
										</div>
									</div>
		...
		<?php else : ?>
			...
			<?php
			echo anchor('admin/slider_banner/add','<span class="glyphicon glyphicon-plus"></span>');
			?>
		<?php 
