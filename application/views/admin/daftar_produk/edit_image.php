...
if($this->input->post()){
	$caption 		= set_value('judul_produk');
	$description 	= set_value('diskripsi_produk');
} else {
	$caption 		= $image->judul_produk;
	$description 	= $image->diskripsi_produk;
}
?>
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   <li><?php echo anchor('admin/contents/index/page','Halaman');?></li>
                    ...
                    <li><?php echo anchor('admin/galeri','Galeri Produk');?></li>
                </ul>
...
<div id="container" class="container" style="padding-top:60px;">
	...
	<div id="body">
		...
		<?php endif; ?>
		<?=form_open_multipart('admin/daftar_produk/edit/'.$image->id_daftar_produk)?>

		  <div class="form-group">
		    <label for="userfile">Gambar</label>
		    <div class="row" style="margin-bottom:5px"><div class="col-xs-12 col-sm-6 col-md-3"><?=img(array('src'=>$image->gambar,'width'=>'100%'))?></div></div>
		    <input type="file" class="form-control" name="userfile">
		  </div>
		   <div>
		 	 <?php
                echo form_label('Bahasa Terjemahan','id');
                echo form_error('id');
                echo form_dropdown('id_languages',$bahasanya,set_value('id'),'class="form-control"');
                ?>	
		  </div>
		  <div class="form-group">
		  ...
		  <?=anchor('admin/daftar_produk','Cancel',array('class'=>'btn btn-warning'))?>
