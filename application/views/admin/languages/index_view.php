        ...
        <div class="col-lg-12" style="margin-top: 10px;">
            ...
            if(!empty($languages))
            {
                ...
                foreach($languages as $lang)
                {
                    ...
                    echo '</td>';
                    echo '<td>'.anchor('admin/languages/update/'.$lang->id,'<span class="glyphicon glyphicon-pencil"></span>').' '.anchor('admin/languages/delete/'.$lang->id,'<span class="glyphicon glyphicon-remove"></span>').' '.anchor('admin/languages/edit_text/'.$lang->language_directory,'<span class="glyphicon glyphicon-book"></span>').'</td>';
					echo '</tr>';
                }
