...
<div class="container" style="margin-top:20px;">
		<div class="col-lg-10">
		 ...
		 <div id="toolbar">
			<button class="btn btn-primary" data-toggle="modal" data-target="#formTambahPendaftaran">
    ...
    $('form').submit(function(event) { //Trigger on form submit
        ...
        $.ajax({ //Process the form using $.ajax()
            ...
            success   : function(data) {
						if (!data.success) { //If fails
							$modal.modal('hide');
							showAlert(($modal.data('no_pendaftaran') ? 'Update' : 'Create') + ' Gagal tambah data!', 'danger');
						}
						else {
								$modal.modal('hide');
								$table.bootstrapTable('refresh');
								$("form").trigger("reset");
								showAlert(($modal.data('no_pendaftaran') ? 'Update Data' : 'Tambah Data') + ' berhasil!', 'success');
							}
						}
        });
